...
**Ordine di esecuzione reale** delle **57 storie evolutive da implementare** (UC `0061`–`0120`, epiche `12`–`22`; sono 60
...
e che **supera l'epica 14**; le sue storie `0119` (responsività del backoffice) e `0120` (guida di collaudo manuale unica)
sono state aggiunte il 22 agosto 2026, dopo il collaudo a mano del lotto `0095`–`0099`.
...
| 15 | [0119](22-refactor-membership-model/story/0119-responsivita-backoffice.md) | Responsività del backoffice: tabelle a più colonne, barra laterale e comandi su schermo stretto | 22 | 0100, 0103, 0104 | 0019, 0020 | 🟢 | ⬜ |
| 16 | [0105](22-refactor-membership-model/story/0105-governo-listino-console-piattaforma.md) | Governo del listino dalla console di piattaforma (dal ciclo successivo) | 22 | 0102 | 0021, 0047 | 🟢 | ⬜ |
| 17 | [0106](22-refactor-membership-model/story/0106-posti-in-billing.md) | I posti nella sezione «Billing»: righe, storico, prossimo rinnovo | 22 | 0103, 0105, **0096** | 0067 | 🟢 | ⬜ |
| 18 | [0107](22-refactor-membership-model/story/0107-menu-rotte-visibilita-per-ruolo.md) | Menu, rotte e visibilità per ruolo (intersezione a tre) | 22 | 0099, 0100, **0077** | 0020 | 🟢 | ⬜ |
| 19 | [0108](22-refactor-membership-model/story/0108-cruscotto-collaboratore.md) | Cruscotto del collaboratore, senza azioni dispositive | 22 | 0107, **0097** | — | 🟢 | ⬜ |
| 20 | [0109](22-refactor-membership-model/story/0109-catalogo-sola-lettura-richiesta-owner.md) | Catalogo in sola lettura + richiesta «chiedi all'owner di installare» | 22 | 0107, **0095**, 0085 | 0018 | 🟢 | ⬜ |
| 21 | [0110](22-refactor-membership-model/story/0110-miei-dati-forma-ridotta.md) | «I miei dati» in forma ridotta per il collaboratore | 22 | 0107 | 0033 | 🟢 | ⬜ |
| 22 | [0111](22-refactor-membership-model/story/0111-schermata-gestione-utenti-app.md) | Schermata «Gestione utenti» dentro ogni applicazione (+ ritiro dei posti del Mini-CRM) | 22 | 0098, 0099, 0101, 0107 | 0027 | 🟢 | ⬜ |
| 23 | [0112](22-refactor-membership-model/story/0112-copilota-ruoli-new-application.md) | Copilota dei ruoli nella skill `new-application` + parità dello scaffolding | 22 | 0101, 0099, 0111 | 0046 | 🟢 | ⬜ |
| 24 | [0114](22-refactor-membership-model/story/0114-ritiro-categoria-b2c-b2b.md) | Ritiro della categoria B2C/B2B delle applicazioni (`App.user_model`) | 22 | 0099, 0101, 0112 | 0022 | 🟢 | ⬜ |
| 25 | [0115](22-refactor-membership-model/story/0115-ambito-dati-applicazione.md) | Ambito dei dati di un'applicazione: dichiarazione + guardia (il filtro va con la prima app che lo usa) | 22 | 0114, 0101 | 0032 | 🟢 | ⬜ |
| 26 | [0113](22-refactor-membership-model/story/0113-migrazione-account-e-copertura-e2e.md) | Migrazione degli account esistenti + copertura end-to-end per ruolo | 22 | tutte le precedenti dell'epica, **0090**, **0093** | 0045 | 🟢 | ⬜ |
| 27 | [0120](22-refactor-membership-model/story/0120-guida-collaudo-manuale-epica.md) | Guida di collaudo manuale unica di fine epica (soli passi visivi, per percorsi) | 22 | **tutte** le precedenti dell'epica, in particolare 0113 | — | 🟢 | ⬜ |
| **B. Messa in cloud & go-live** |
| 28 | [0080](16-messa-in-cloud-golive/0080-prima-esecuzione-live-pipeline.md) | Prima esecuzione live pipeline + config repo GitHub | 16 | — | 0005, 0003, 0004, 0055 | 🟢 | ⬜ |
| 29 | [0082](16-messa-in-cloud-golive/0082-script-attivazione-ambienti-fasi.md) | Script attivazione ambienti (`test-start`/`test-stop` + cron) | 16 | 0080 | 0004, 0055, 0005, 0006 | 🟢 | ⬜ |
| 30 | [0079](16-messa-in-cloud-golive/0079-gestione-rimbalzi-reclami-ses.md) | Gestione rimbalzi/reclami SES | 16 | — | 0018, 0006 | 🟢 | ⬜ |
| 31 | [0078](16-messa-in-cloud-golive/0078-uscita-ses-sandbox.md) | Uscita di SES dalla sandbox _(bloccante go-live)_ | 16 | 0079 | 0018 | 🟢 | ⬜ |
| 32 | [0081](16-messa-in-cloud-golive/0081-smoke-reali-cloud-test.md) | Smoke reali cloud alla prima accensione `test` | 16 | 0080, 0082 | 0015, 0016, 0014, 0018, 0055, 0005 | 🟢 | ⬜ |
| 33 | [0083](16-messa-in-cloud-golive/0083-drift-regione-e-casella-security.md) | Drift regione `eu-south-1`→`eu-west-1` + casella `security@` | 16 | 0080 (soft) | 0005, 0037, 0049 | 🟢 | ⬜ |
| **C. Self-service, supporto, contenuti** |
| 34 | [0067](13-abbonamenti-self-service/0067-gestione-abbonamento-self-service.md) | Gestione abbonamento self-service (backoffice "Abbonamenti") | 13 | — | 0026, 0028, 0027, 0024, 0020 | 🟢 | ✅ |
| 35 | [0071](13-abbonamenti-self-service/0071-riconciliazione-netto-revenue.md) | Riconciliazione netto/revenue | 13 | — | 0025, 0006, 0021 | 🟢 | ✅ |
| 36 | [0075](15-supporto-e-piattaforma/0075-ticketing-nativo-in-house.md) | Ticketing nativo in-house | 15 | 0085 (soft) | 0012, 0013, 0020, 0021, 0018, 0034 | 🟢 | ✅ |
| 37 | [0076](15-supporto-e-piattaforma/0076-disabilita-applicazione.md) | Disabilita applicazione (feature admin reversibile) | 15 | — | 0021, 0027, 0014, 0035 | 🟢 | ✅ |
| 38 | [0084](17-skill-e-tooling-contenuto/0084-skill-new-blog-post.md) | Skill `new-blog-post` | 17 | 0086 (soft) | 0042, 0057, 0046, 0040, 0041 | 🟢 | ✅ |
| **C2. Test end-to-end di piattaforma** |
| 39 | [0090](20-test-e2e-piattaforma/0090-e2e-platform-fondamenta.md) | Fondamenta suite e2e di piattaforma (stack reale + Mailpit + primo journey) | 20 | — | 0058, 0018, 0020, 0023, 0029 | 🟢 | ✅ |
| 40 | [0091](20-test-e2e-piattaforma/0091-e2e-platform-journey-utente.md) | Batteria journey e2e lato utente | 20 | 0090 | 0024, 0027, 0059, 0028, 0033, 0056 | 🟢 | ✅ |
| 41 | [0092](20-test-e2e-piattaforma/0092-e2e-platform-journey-admin.md) | Batteria journey e2e lato admin + guasti di piattaforma | 20 | 0090, 0076, 0077 | 0021, 0034 | 🟢 | ✅ |
| 42 | [0093](20-test-e2e-piattaforma/0093-e2e-platform-registro-copertura.md) | Registro di copertura e2e + check meccanico | 20 | 0090, 0091, 0092 | 0045 | 🟢 | ✅ |
| 43 | [0094](20-test-e2e-piattaforma/0094-e2e-platform-workflow-skill.md) | Integrazione copertura e2e nel workflow delle skill | 20 | 0093 | 0044, 0045, 0046 | 🟢 | ✅ |
| **C3. Catalogo app & UX backoffice** |
| 44 | [0095](21-catalogo-app-backoffice/0095-pagina-app-catalog.md) | Pagina "App catalog" del backoffice (card, stati, ricerca, paginazione) | 21 | 0077 | 0020, 0022, 0024, 0026 | 🟢 | ✅ |
| 45 | [0096](21-catalogo-app-backoffice/0096-billing-solo-fatturazione.md) | Billing solo-fatturazione (abbonamenti + storico pagamenti/ricevute) | 21 | 0095, 0076 (soft), 0077 | 0028, 0025, 0026 | 🟢 | ✅ |
| 46 | [0097](21-catalogo-app-backoffice/0097-dashboard-operativa.md) | Dashboard operativa del workspace (+ Workspace ID in Account) | 21 | 0095, 0077 | 0027, 0028, 0059, 0056 | 🟢 | ✅ |
| **D. Direzione di prodotto da decidere** |
| 47 | [0061](12-ready-for-ai-mcp/0061-architettura-server-mcp.md) | Architettura & collocazione del server MCP | 12 | — | 0004, 0055, 0051, 0014 | 🟠 | ⬜ |
| 48 | [0062](12-ready-for-ai-mcp/0062-auth-consenso-delegato-ai.md) | Autenticazione e consenso delegato (AI → tenant) | 12 | 0061 | 0015, 0016, 0013 | 🟠 | ⬜ |
| 49 | [0063](12-ready-for-ai-mcp/0063-mappatura-operazioni-strumenti-mcp.md) | Mappatura operazioni → strumenti MCP | 12 | 0061 | 0051, 0046 | 🟠 | ⬜ |
| 50 | [0064](12-ready-for-ai-mcp/0064-enforcement-quota-entitlement-ai.md) | Enforcement entitlement/quota sulle chiamate AI | 12 | 0061 · 0077 (soft) | 0027, 0026 | 🟠 | ⬜ |
| 51 | [0065](12-ready-for-ai-mcp/0065-sicurezza-audit-invocazioni-ai.md) | Sicurezza & audit invocazioni AI + privacy | 12 | 0061 | 0006, 0030 | 🟠 | ⬜ |
| 52 | [0066](12-ready-for-ai-mcp/0066-industrializzazione-mcp-newapp.md) | Industrializzazione MCP + riconciliazione claim sito | 12 | 0061, 0062, 0063, 0064, 0065 | 0046, 0004, 0037 | 🟠 | ⬜ |
| 53 | [0069](13-abbonamenti-self-service/0069-trial-una-tantum-tenant-app.md) | Trial una-tantum per tenant×app | 13 | — | 0026, 0024, 0027 | 🟠 | ⬜ |
| **E. Bassa priorità / deprioritizzate** |
| 54 | [0068](13-abbonamenti-self-service/0068-pausa-ripresa-subscription.md) | Pausa/ripresa subscription self-service | 13 | — | 0026, 0028, 0020 | 🟢 | ⬜ |
| 55 | [0070](13-abbonamenti-self-service/0070-bundling-abbonamento-multi-app.md) | Bundling: più app in un unico abbonamento | 13 | — | 0022, 0026 | 🟢 | ⬜ |
| 56 | [0088](19-debito-tecnico/0088-search-globale-workspace.md) | Search globale dal workspace del backoffice | 19 | — | 0020, 0013 | 🟢 | ⬜ |
| 57 | [0089](19-debito-tecnico/0089-rimozione-legacy-peer-deps.md) | Rimozione `legacy-peer-deps` nel frontend | 19 | — | 0020, 0019 | 🟢 | ⬜ |
...
- **Epica 22 (appartenenza)**: `0116` (identità e appartenenze) apre e precede **tutto**, `0098` compreso, perché
  ...
  **`0095`** e `0085`), `0110`; dentro le applicazioni `0111` → `0112` → `0114` → `0115`; `0113` (migrazione e
  copertura) dipende da **tutte** le precedenti dell'epica più **`0090`** e **`0093`**; e `0120` (guida di collaudo
  manuale unica) chiude, dopo `0113`. La sola storia che **non** segue la catena è `0119` (responsività del
  backoffice): non ha prerequisiti oltre le schermate che presidia (`0100`, `0103`, `0104`, tutte in `main`) e sta
  **prima** di `0105` per una ragione di costo — le storie che seguono aggiungono ancora colonne e comandi alle stesse
  tabelle, e il suo collaudo le sorveglia tutte.
...
- **Epica 22**: le sue ventitré storie sono **🟢 decise** — i requisiti sono stati dettati dallo sviluppatore e
...
- **Collaudo visivo sospeso dentro l'epica 22** (decisione dello sviluppatore del 22 agosto 2026): per le storie
  dell'epica non si chiede più di guardare schermate a ogni storia — in un rifacimento gli stati intermedi non sono
  giudicabili a vista. Le guide `how-to-test.md` si scrivono comunque e i loro passi **non visivi** si eseguono; il
  presidio contro i regressi resta la suite automatica completa verde a ogni commit. La sospensione **decade** con
  l'esecuzione della guida unica di `0120`. Testo integrale della decisione nel
  ...
  Vale **solo** per l'epica 22: non è una regola generale, e `CLAUDE.md` e le skill non sono stati toccati.
