...
/* Tavolozza ciclica del mockup per gli avatar cliente (assegnazione stabile per nome). */
const AVATAR_TINTS = [
  'bg-cat-blue',
  'bg-cat-violet',
  'bg-cat-teal',
...
/** Avatar quadrato 28px con le iniziali del cliente, colore stabile per nome (mockup tabella Invoices). */
