...
privacy `privacy-scan.mjs`, UC 0031; il check `@PersonalData`↔manifesto gira nei test backend). Esegue tutte le aree, non si ferma al primo errore e ritorna exit-code ≠ 0 se una qualsiasi suite è
