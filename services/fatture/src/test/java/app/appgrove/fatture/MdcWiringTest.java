...
/**
 * Wiring MDC di una richiesta autenticata (invariante #4, UC 0006), lato app: i campi arrivano
 * dal framework (commons) e {@code app_id=fatture} dal filtro del servizio; il correlation id
...
class MdcWiringTest {
    ...
    void unaRichiestaAutenticataProduceUnLogConTuttiICampiMdc() {
        ...
        assertEquals("fatture", mdc.get("app_id"));
