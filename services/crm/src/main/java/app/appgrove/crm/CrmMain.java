...
/**
 * Entrypoint del servizio crm. Default: avvia il server HTTP ({@code waitForExit}). In
 * <b>command-mode</b> {@code migrate} applica le migrazioni Flyway (schema {@code app_crm}) e
 ...
 */
@QuarkusMain
public class CrmMain implements QuarkusApplication {

    private static final Logger LOG = Logger.getLogger(CrmMain.class);
