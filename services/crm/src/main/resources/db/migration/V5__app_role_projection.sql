...
-- INVALIDATA dal consumer della coda entitlement-crm, la stessa dei diritti d'accesso: una coda
...
create table if not exists app_crm.app_role_projection (
...
comment on table app_crm.app_role_projection is
