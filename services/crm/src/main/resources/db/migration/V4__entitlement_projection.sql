...
-- entitlement-crm. Nessuna lettura cross-schema: l'app non tocca mai lo schema di core.

create table if not exists app_crm.entitlement_projection (
...
comment on table app_crm.entitlement_projection is
