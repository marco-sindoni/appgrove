...
/**
 * Sta al posto della <b>rete di sicurezza</b> (la chiamata REST reale a core) nei test: offline e
 * deterministico. Default = accesso pieno con tetto free (2 seats/mese).
 *
...
public class MockEntitlementService implements EntitlementService, EntitlementViewSource {
    ...
    public Optional<EntitlementView> viewFor(String appSlug) {
        ...
        return Optional.of(new EntitlementView(
                ...
                null,
                null,
                Map.of("seats", new MetricLimit(cap, "stock", null))));
    }
}
