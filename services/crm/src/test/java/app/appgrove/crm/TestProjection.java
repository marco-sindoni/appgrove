 ...
 * applicazione (UC 0099): azzeramento e ispezione diretta.
 *
...
public class TestProjection {
    ...
    private static final String TABLE = "app_crm.entitlement_projection";
    private static final String ROLE_TABLE = "app_crm.app_role_projection";
