...
/**
 * Gate entitlement (402) lato servizio (UC 0027): un endpoint {@code @RequiresEntitlement} è bloccato
 * con 402 quando il tenant non ha accesso — prima ancora del varco posto. L'endpoint di stato quota,
...
class EntitlementGateTest {
    ...
    void gatedEndpointReturns402WhenNotEntitled() {
        ...
        // l'assegnazione di un posto è @RequiresEntitlement: senza accesso → 402, prima di ogni altra logica
    ...
    void gatedEndpointAllowsWhenEntitled() {
        ...
        // con accesso e posto, il dominio risponde
        CrmApi.createContact(TestTokens.withTenant(TENANT, "owner"), "Con accesso");
    }
