 ...
 * seed condiviso ({@code dev/seed/seed.sql}, idempotente). auth-local non possiede migrazioni: in dev
...
final class TestSchema {
    ...
    static synchronized void ensure(AgroalDataSource ds) {
        Path base = Path.of(System.getProperty("user.dir")); // services/auth-local
