...
-- INVALIDATA dal consumer della coda entitlement-@@APP_ID@@, la stessa dei diritti d'accesso: una coda
...
create table if not exists @@SCHEMA@@.app_role_projection (
...
comment on table @@SCHEMA@@.app_role_projection is
