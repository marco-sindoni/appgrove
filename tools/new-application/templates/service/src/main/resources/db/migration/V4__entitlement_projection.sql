...
-- entitlement-@@APP_ID@@. Nessuna lettura cross-schema: l'app non tocca mai lo schema di core.

create table if not exists @@SCHEMA@@.entitlement_projection (
...
comment on table @@SCHEMA@@.entitlement_projection is
