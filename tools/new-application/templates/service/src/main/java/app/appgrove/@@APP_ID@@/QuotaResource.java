 ...
 * <b>dichiarata col suo motivo</b> in {@code @@APP_CLASS@@OperationsContract}. Il consumo va letto anche da
 * chi non è ancora stato abilitato all'applicazione: un banner che diventa un rifiuto non informa nessuno.
 * Chi aggiungesse qui un {@code @RequiresAppRole} «per coerenza» renderebbe rossa la suite, ed è il
